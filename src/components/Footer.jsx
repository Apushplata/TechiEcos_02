...
const Footer = () => {
  return (
    ...
    <div className='container first-container'>
      ...
      <Link to='https://www.linkedin.com/company/96943280/admin/feed/posts/' target='_blank'><FaLinkedin className='social' style={{ color: "white" , height: "30px" , width: "30px"}} /></Link>
      <Link to='https://twitter.com/techiEco_S' target='_blank'><FaTwitter className='social' style={{ color: "white" , height: "30px" , width: "30px" }} /></Link>
      <Link to='https://www.instagram.com/techieco_solutions/' target='_blank'><RiInstagramFill className='social' style={{ color: "white" , height: "30px" , width: "30px"}} /></Link>
